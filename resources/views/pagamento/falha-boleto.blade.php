...
@section('header_title', 'Falha no Pagamento - Boleto')

@section('content')
<div class="container py-5">
    <h2 class="mb-4 text-center">Pagamento via Boleto - Falha</h2>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-danger">
                <div class="card-header bg-danger text-white">Erro no Pagamento</div>
                <div class="card-body text-center">
                    <p>Infelizmente, ocorreu uma falha ao gerar ou processar o boleto.</p>
